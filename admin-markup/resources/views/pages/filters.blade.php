...
@section('content')
    ...
    <main>
        <div class="content">
            <h2 class="content-heading">Фильтры</h2>
            <div class="block">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter js-dataTable-full">
                            ...
                            <tr>
                                ...
                                <td class="font-w600">Вина</td>
                                <td class="font-w600"><span class="badge badge-success">Отображать</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="font-w600">Мясо</td>
                                <td class="font-w600"><span class="badge badge-danger">Не отображать</span></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <form id="formItem" action="" method="post">
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-gd-emerald">
                            <h3 class="block-title">Добавить фильтр</h3>
                        ...
                        <div class="block-content row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-12  mt-10" for="example-select2-multiple">Категория</label>
                                    <div class="col-lg-12">
